  ...
  return (
    <article>
      <section className="flex flex-col justify-center items-center py-10">
        <Image alt="꽁머니팡소개" width={248} height={255} src={money}></Image>
        ...
        <div className="w-full max-w-[1000px] pt-20 px-5 flex items-center justify-between">
          <section className="hidden lg:flex w-1/2 h-full  flex-col justify-center items-center">
            <div className="font-bold text-center">
              <h1 className="text-2xl ">꽁머니 홍보 게시판</h1>
          ...
          <section className="w-full flex flex-col gap-5 ">
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full h-36 max-w-80  relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    해당 게시판은 먹튀 검증 게시판이 아닙니다. 먹튀 사이트나
                    사기 사이트가 있을 수 있음으로 꽁머니를 지급한다고 하더라도
                    사이트가 안전한지 확인 후에 이용하셔야 합니다.
                  </p>
                </div>
              </article>
              <article className="w-full h-36 max-w-80  relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    꽁머니는 물론이고 토토 사이트에서 진행하는 이벤트를 홍보할
                    수 있습니다. 꽁머니, 가입머니, 입금 플러스 머니 등
                    사이트에서 유저에게 제공하는 혜택이 있다면 해당 게시판을
                    통해 홍보가 가능합니다.
                  </p>
                </div>
              </article>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    사이트명과 주소를 명확하게 기재하는 것이 좋습니다.
                    사이트명이 다르거나 사이트주소가 입력되지 않으면 꽁머니 홍보
                    효과가 저하될 수 있습니다.
                  </p>
                </div>
              </article>
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    댓글을 통해 정보를 함께 나눌 수 있습니다. 게시글 내에 댓글을
                    달아 다양한 정보들을 주고받을 수 있습니다. 다른 게시판을
                    이용할 수도 있지만 도움이 될만한 기초적인 정보들을 댓글을
                    통해 나눈다면 많은 사람들에게 좋은 정보를 제공할 수
                    있습니다.
                  </p>
                </div>
              </article>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    가입 코드를 적어야 합니다. 가입 코드를 명확하게 기재할 때
                    고객 유치 효과가 큽니다.
                  </p>
                </div>
              </article>
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    ...
                    좋습니다. 단순히 ‘꽁머니 지급’으로 제목을 작성하기보다는
                    어떤 사이트에서 어느 정도의 꽁머니를 어떤 기준으로
