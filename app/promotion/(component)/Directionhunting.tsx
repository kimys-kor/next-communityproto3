        ...
        <div className="w-full max-w-[1000px] pt-20 px-5 flex items-center justify-between">
          <section className="hidden lg:flex w-1/2 h-full  flex-col justify-center items-center">
            <div className="font-bold text-center">
              <h1 className="text-2xl ">구인구직 홍보 게시판</h1>
          ...
          <section className="w-full flex flex-col gap-5 ">
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full h-36 max-w-80  relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    구인 / 구직 카테고리 선택하기 구인 / 구직 중 원하는 상태를
                    선택합니다. 정확하게 구인 / 구직을 선택해야 빠른 소통과 정보
                    공유가 가능해집니다.
                  </p>
                </div>
              </article>
              <article className="w-full h-36 max-w-80  relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    구인구직 내용을 게시할 때는 직관적이고 구체적인 제목을
                    사용하는 것이 좋습니다. 예를 들어 ‘구인 모집합니다’와 같은
                    제목보다는 ‘총판, 파트너 모집합니다’와 같은 제목을 사용하는
                    것이 도움이 됩니다.
                  </p>
                </div>
              </article>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    구인, 구직 내용이 아닌 홍보를 목적으로 한 게시글은 통보 없이
                    삭제될 수 있음으로 주의합니다. 홍보를 목적으로 한다면
                    ‘일반홍보’게시판을 이용해 주시기 바랍니다.
                  </p>
                </div>
              </article>
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    다른 사이트나 사람을 비방할 목적으로 해당 게시판을 이용할 수
                    없습니다.
                  </p>
                </div>
              </article>
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full justify-center items-center">
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    사실이 아닌 내용을 올려서는 안 되며, 허위 구인 구직 게시글로
                    인지될 경우 통보 없이 게시글이 삭제될 수 있습니다.
                  </p>
                </div>
              </article>
              <article className="w-full max-w-80 h-36 relative px-5 py-5 text-sm rounded-lg  border border-solid border-[#EEEEEE] flex items-center justify-center">
                <div>
                  <p className="">
                    다른 사람의 의견이나 게시글을 비방하거나 악의적인 욕설을
                    하지 않습니다.
                  </p>
                </div>
              </article>
